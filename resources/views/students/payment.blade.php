                        ...
                        <div class="mb-4">
                            <form class="row g-3" action="{{ url('students/payment/' . $student->id) }}" method="POST">
                                ...
                                <div class="row mt-4 g-3">
                                    ...
                                    <div class="col-3">
                                        <label for="inputFatherName" class="form-label">Amount paid<sup><i
                                                    class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="text" class="form-control" id="inputFatherName" name="amount_paid"
                                            placeholder="Amount paid" required>
                                    </div>
                                    <div class="col-3">
                                        <label for="inputFatherName" class="form-label">Payment Method<sup><i
                                                    class="bi bi-asterisk text-primary"></i></sup></label>
                                        {{-- <input type="text" class="form-control" id="inputFatherName" name="father_name"
                    placeholder="Name" required> --}}
                                        <select id="" class="form-select" name="payment_type">
                                ...
                                <div class="row g-3">
                                    ...
                                    {{-- <div class="col-2">
                                        ...
                                        <select id="inputBloodType" class="form-select" name="blood_type" required>
                                            <option value="A+"
                                                {{ $student->blood_type == 'A+' ? 'selected' : null }}>
                                                A+
                                            </option>
                                            <option value="A-"
                                                {{ $student->blood_type == 'A-' ? 'selected' : null }}>A-
                                            </option>
                                            <option value="B+"
                                                {{ $student->blood_type == 'B+' ? 'selected' : null }}>B+
                                            </option>
                                            <option value="B-"
                                                {{ $student->blood_type == 'B-' ? 'selected' : null }}>B-
                                            </option>
                                            <option value="O+"
                                                {{ $student->blood_type == 'O+' ? 'selected' : null }}>O+
                                            </option>
                                            <option value="O-"
                                                {{ $student->blood_type == 'O-' ? 'selected' : null }}>O-
                                            </option>
                                            ...
                                            <option value="AB-"
                                                ...
                                                AB-</option>
                                            <option value="Other"
                                                {{ $student->blood_type == 'Other' ? 'selected' : null }}>Other</option>
                                        </select>
                                    </div>
                                    <div class="col-2">
                                    ...
                                    {{-- <div class="col-3">
                                        ...
                                        <input type="text" class="form-control" id="inputPhone" name="phone"
                                            placeholder="+234 ..." required value="{{ $student->phone }}">
                                    </div>
                                    <div class="col-3">
                                ...
                                {{-- <div class="row mt-4 g-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control" id="inputFatherPhone" name="father_phone"
                                            placeholder="+880 01......" required value="{{ $parent_info->father_phone }}">
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone"
                                            placeholder="+880 01......" required value="{{ $parent_info->mother_phone }}">
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <a href="{{ url('students/payment-receipt/' . $student->id) }}" role="button"
                                            class="btn btn-sm btn-primary"><i class="bi bi-eye"></i> Print</a>
                                    </div>
