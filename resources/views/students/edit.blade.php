            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="row ">
                    <div class="col ps-4">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ url()->previous() }}">Student
                                                    List</a></li>
                        ...
                        <div class="mb-4 card bg-white px-3 py-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <select id="inputBloodType" class="form-select" name="blood_type" required>
                                            <option value="A+" {{ $student->blood_type == 'A+' ? 'selected' : null }}>
                                                A+
                                            </option>
                                            <option value="A-" {{ $student->blood_type == 'A-' ? 'selected' : null }}>
                                                A-
                                            </option>
                                            <option value="B+" {{ $student->blood_type == 'B+' ? 'selected' : null }}>
                                                B+
                                            </option>
                                            <option value="B-" {{ $student->blood_type == 'B-' ? 'selected' : null }}>
                                                B-
                                            </option>
                                            <option value="O+" {{ $student->blood_type == 'O+' ? 'selected' : null }}>
                                                O+
                                            </option>
                                            <option value="O-" {{ $student->blood_type == 'O-' ? 'selected' : null }}>
                                                O-
                                            ...
                                            <option value="AB+"
                                                {{ $student->blood_type == 'AB+' ? 'selected' : null }}>
                                                AB+</option>
                                            <option value="AB-"
                                                {{ $student->blood_type == 'AB-' ? 'selected' : null }}>
                                                AB-</option>
                                            <option value="Other"
                                                {{ $student->blood_type == 'Other' ? 'selected' : null }}>
                                                Other</option>
                                        </select>
                                    </div>
                                    <div class="col-2">
                                        ...
                                        <select id="inputReligion" class="form-select" name="religion" required>
                                            <option {{ $student->religion == 'Islam' ? 'selected' : null }}>
                                                Islam</option>
                                            <option {{ $student->religion == 'Hinduism' ? 'selected' : null }}>
                                                Hinduism</option>
                                            <option {{ $student->religion == 'Christianity' ? 'selected' : null }}>
                                                Christianity</option>
                                            <option {{ $student->religion == 'Buddhism' ? 'selected' : null }}>
                                                Buddhism</option>
                                            <option {{ $student->religion == 'Judaism' ? 'selected' : null }}>
                                                Judaism</option>
                                            <option {{ $student->religion == 'Other' ? 'selected' : null }}>
                                                Other</option>
                                        </select>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <label for="inputIdCardNumber" class="form-label">Id Card
                                            Number<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                ...
                                <div class="row mt-4 g-3">
                                    ...
                                    <div class="col-3">
                                        <label for="inputFatherName" class="form-label">Father
                                            Name<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    ...
                                    <div class="col-3">
                                        <label for="inputFatherPhone" class="form-label">Father's
                                            Phone<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary w-100"><i
                                                class="ri-user-follow-line"></i> Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
