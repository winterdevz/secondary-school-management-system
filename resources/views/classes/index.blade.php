                                        ...
                                        <div class="card my-3">
                                            ...
                                            <div class="card-body text-dark">
                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active" id="class{{ $school_class->id }}"
                                                        role="tabpanel">
                                                    ...
                                                    <div class="tab-pane fade" id="class{{ $school_class->id }}-syllabus"
                                                        role="tabpanel">
                                                    ...
                                                    <div class="tab-pane fade" id="class{{ $school_class->id }}-courses"
                                                        role="tabpanel">
