                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a href="{{ route('course.syllabus.index', ['course_id' => $course->course->id]) }}"
                                                                        role="button" class="dropdown-item"><i
                                                                            class="bi bi-journal-text me-2"></i> View
                                                                        Syllabus</a></li>
                                                                <li><a href="{{ route('assignment.create', [
                                                                    ...
                                                                    'semester_id' => request()->query('semester_id'),
                                                                        ...
                                                                        role="button" class="dropdown-item"><i
                                                                            class="bi bi-file-post me-2"></i> Create
                                                                        Assignment</a></li>
                                                                ...
                                                                <li><a href="{{ route('course.mark.create', [
                                                                    ...
                                                                    'semester_id' => $selected_semester_id,
                                                                        ...
                                                                        role="button" class="dropdown-item"><i
                                                                            class="bi bi-input-cursor me-2"></i> Give Marks</a>
                                                                </li>
                                                                <li><a href="{{ route('course.mark.list.show', [
                                                                    ...
                                                                    'semester_id' => $selected_semester_id,
                                                                        ...
                                                                        role="button" class="dropdown-item"><i
                                                                            class="bi bi-cloud-sun me-2"></i> View Final
                                                                        Results</a></li>
                                                                <li><a href="#" role="button"
                                                                        class="dropdown-item disabled" tabindex="-1"
